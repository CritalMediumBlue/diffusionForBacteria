...
two pre‑allocated work arrays. The right‑hand side is modified **in place**
during forward elimination and then reused as scratch space for the
modified upper diagonal. The solution is written directly into the
`solution` array.
 ...
 *                                       Modified in place during forward elimination.
 ...
 *
 * thomasAlgorithm(lower, main, upper, rhs, n, modUpper, solution);
