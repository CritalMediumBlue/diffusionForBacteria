...
- \frac{k \Delta t}{2} \left( u_i^{n+1} + u_i^n \right) + \Delta t \, S_i.
$$
...
- \beta \left( u_i^{n+1} + u_i^n \right) + \Delta t \, S_i.
$$
...
\frac{\lambda}{2}{\color{blue} u_{i-1}^{n}} + (1 - \lambda - \beta){\color{blue} u_i^{n}} + \frac{\lambda}{2}{\color{blue} u_{i+1}^{n}} + \Delta t \, S_i,
$$
...
$$
d_i = \frac{\lambda}{2} u_{i-1}^n + (1 - \lambda - \beta) u_i^n + \frac{\lambda}{2} u_{i+1}^n + \Delta t \, S_i,
$$
