...
const sourcesTestCases = [
    { description: "infrequent sources", probability: 0.001 },
    { description: "dense sources", probability: 0.03 },
];
...
describe("Crank-Nicolson vs ADI Comparison", () => {
    ...
    test.each(sourcesTestCases)("$description", ({ probability }) => {
        ...
        CNSetParameters(WIDTH, DIFFUSION_RATE, deltaX, deltaT, K_I, K_O, sinkCounts, sourceCounts);
        ...
        ADI(numericalSolutionADI, totalIterations);
